...
"""Build and simulator-check the M0 CoreMark measurement."""
...
def main() -> int:
    ...
    log_path = build_dir / "coremark.all_enabled.sim.log"
    ...
    if backend == "modelsim":
        ...
        built, reason, binary = build_verilator(
            ...
            binary_name="Vsoc_tb_coremark_all_enabled",
    ...
    print(
        "COREMARK SIM PASS: "
        f"backend={backend} iterations={args.iterations} mcycle={mcycle} "
