...
module soc #(
  ...
  // ext_irq_i[0] maps to PLIC source 17. M0 ties the DMA/device slots 5..16
  ...
  uart_apb #(
    ...
    // M0 has no DMA engine; keep the shared UART endpoint inactive.
    .dma_tx_valid_i(1'b0),
    .dma_tx_data_i (8'h00),
    .dma_tx_ready_o(),
