...
// SPDX-License-Identifier: BSD-3-Clause
  ...
  // JTAG agent used by the debug tests.  The trace is deliberately restricted
  // to the boot window so a malformed host file cannot turn into arbitrary
  // debug-register traffic in this verification path.
