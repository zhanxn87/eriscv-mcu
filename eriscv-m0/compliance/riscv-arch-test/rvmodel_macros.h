 ...
 */
#define RVMODEL_BOOT_TO_MMODE   csrw mie, zero          ;   csrw mip, zero          ;   csrw mepc, zero         ;   csrw mtval, zero        ;   csrw mcause, zero       ;   RVTEST_TRAP_PROLOG M    ;   csrr t1, mscratch       ;   sw zero, 0(t1)          ;   la t0, common_Mentry    ;   sw t0, tentry_addr_off(t1) ;   li t0, MSTATUS_MPP      ;   csrw mstatus, t0
