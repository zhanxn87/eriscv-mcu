...
set top_name "eriscv_m1_vcu108_wrapper"
set project_name "eriscv_m1_vcu108"
...
proc setup_vcu108_project {} {
  ...
  if {[file exists $project_file]} {
    ...
    # Keep persistent Vivado projects synchronized with the product filelist
    # when a new local RTL module is introduced.
  ...
  # Vendor RTL can contain independently elaboratable modules. Reassert the
  # board wrapper for both new and persistent projects to prevent auto-top
  # selection from targeting a non-SoC leaf module.
  set_property top $top_name [get_filesets sources_1]
  configure_run_strategies
  puts "INFO: M1 VCU108 project ready: $project_file"
}
