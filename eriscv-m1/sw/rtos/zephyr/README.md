# eRISCV-M1 Zephyr Port

Zephyr RTOS v3.6 LTS board and SoC port for the eRISCV-M1 educational RISC-V MCU.
...
# Build from M1 sw directory
make -C eriscv-m1/sw zephyr

# Or build directly with cmake
cd eriscv-m1/sw/rtos/zephyr
make images
```
...
```bash
make -C eriscv-m1/sw sim-zephyr
```
...
| Board | `eriscv_mcu` |
| SoC | `eriscv_mcu` |
| Architecture | RV32IMC (Zicsr, Zifencei) |
