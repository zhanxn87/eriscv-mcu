...
"""Build and run an eRISCV-M1 BSP UART smoke, preferring Verilator."""
...
def main() -> int:
    ...
    build_dir = ROOT / "eriscv-m1/sw/build" / args.example
    subprocess.run(
        ["make", "-C", str(ROOT / "eriscv-m1/sw"), f"EXAMPLE={args.example}", "images"],
        check=True,
    )
