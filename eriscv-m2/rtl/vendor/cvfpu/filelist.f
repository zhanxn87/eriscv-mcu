// M2-selected immutable CVFPU/FPnew source manifest.
// Source order follows the locked upstream Bender.yml; no network fetch occurs.

-f ../fpu_div_sqrt_mvp/filelist.f
