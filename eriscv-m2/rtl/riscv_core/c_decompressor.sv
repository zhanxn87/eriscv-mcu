    ...
    unique case (op)
      2'b00: begin  // C0: register-based operations + loads/stores
        unique case (funct3)
          ...
          3'b011: begin  // c.flw -> flw fd', offset[6:2](rs1')
            instr_o = {
                5'b00000, c_instr_i[5], c_instr_i[12:10], c_instr_i[6],
                2'b00, 2'b01, c_instr_i[9:7], 3'b010,
                2'b01, c_instr_i[4:2], 7'b0000111
            };
          end
          ...
          3'b111: begin  // c.fsw -> fsw fs2', offset[6:2](rs1')
            instr_o = {
                5'b00000, c_instr_i[5], c_instr_i[12],
                2'b01, c_instr_i[4:2], 2'b01, c_instr_i[9:7], 3'b010,
                c_instr_i[11:10], c_instr_i[6], 2'b00, 7'b0100111
            };
          end
          default: begin
            illegal_o = 1'b1;
      ...
      2'b10: begin  // C2: stack-relative + register moves + control
        unique case (funct3)
          ...
          3'b011: begin  // c.flwsp -> flw fd, offset[7:2](x2)
            instr_o = {
                4'b0000, c_instr_i[3:2], c_instr_i[12], c_instr_i[6:4], 2'b00,
                5'b00010, 3'b010, c_instr_i[11:7], 7'b0000111
            };
          end
          ...
          3'b111: begin  // c.fswsp -> fsw fs2, offset[7:2](x2)
            instr_o = {
                4'b0000, c_instr_i[8:7], c_instr_i[12], c_instr_i[6:2],
                5'b00010, 3'b010, c_instr_i[11:9], 2'b00, 7'b0100111
            };
          end
          default: begin
            illegal_o = 1'b1;
